                ...
                <Container>
                    <div className="flex flex-wrap">
                        <div className="p-2 w-full">
                            <h1 className="text-2xl font-bold text-gary-700 hover:text-slate-900">
                                Login to Avail the Takeaway Food Service!
                            </h1>
                            <h1>(Head to top right corner)</h1>
                        </div>
                    </div>
                </Container>
            </div>
...
//     if (totalAmount > 0) {
//       setPaymentStatus(`Amount Paid of Rs.${totalAmount}`);
//       setTotalAmount(0);
//       setSelectedItems([]);
//     }
//   };
...
//               className=" fixed top-24 ml-4 bg-blue-700/60 hover:bg-green-700 text-white font-bold py-2 px-4 rounded "
//             >
//               Pay : Rs.{totalAmount}
//             </button>
//           </>
